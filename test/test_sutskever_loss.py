...
def test_sutskever_preloss_yat():
    ...
    (y_pad, t_pad) = sutskever._loss(eosi, y, t)
    ...
    assert(np.allclose(y_pad[1, :, :].tag.test_value, [
        [0.6, 0.3333333, 1.0, 1.0],
        [0.2, 0.3333333, 1.0, 1.0],
        [0.2, 0.3333333, 1.0, 1.0]
    ]))
...
def test_sutskever_preloss_yget():
    ...
    assert(np.allclose(y_pad[1, :, :].tag.test_value, [
        [0.6, 0.3333333, 1.0, 1.0, 1.0],
        [0.2, 0.3333333, 1.0, 1.0, 1.0],
        [0.2, 0.3333333, 1.0, 1.0, 1.0]
    ]))
...
def test_sutskever_preloss_ylet():
    ...
    # Assert
    assert(np.allclose(y_pad[0, :, :].tag.test_value, [
        [0.1, 0.1, 0.7, 0.3333333],
        [0.1, 0.6, 0.1, 0.3333333],
        [0.8, 0.3, 0.2, 0.3333333]
    ]))
    assert(np.allclose(y_pad[1, :, :].tag.test_value, [
        [0.6, 0.3333333, 1.0, 1.0],
        [0.2, 0.3333333, 1.0, 1.0],
