...
plt.subplot(2, 1, 1)
plt.plot(train_sizes, miss_error, '-x', color='SteelBlue', label='test')
...
plt.subplot(2, 1, 2)
plt.plot(train_sizes, train_loss, '-x', color='IndianRed', label='train')
plt.plot(train_sizes, test_loss, '-x', color='SteelBlue', label='test')
